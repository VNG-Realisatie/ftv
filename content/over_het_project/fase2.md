...
1. **Een standaard voorstellen door:**
...
2. **Draagvlak voor de standaard verkrijgen door:** 
...
3. **Positionering van de standaard door:**
...
4. **Bewijslast leveren van het nut en de haalbaarheid van de standaard door:** 
...
5. **Implementatie faciliteren door:** 
...
> Download hier het [activiteitenverslag](/ftv/documents/activiteitenverslag-fase-2.pdf) van fase 2.

- Doelen 1, 2 en 3: de standaarden, met draagvlak en afstemming, zijn behaald, met uitzondering van het juridisch beleidskader. 
- Doel 4, bewijslast, is gehaald voor zover zinvol. Verder bouw van software heeft alleen nut als daar vraag naar is vanuit PoC’s of projecten. 
- Doel 5, implementatie, is vrijwel niet gehaald. De FDS-context bestaat nog niet in de praktijk, en FTV zonder FDS heeft meestal niet voldoende business case.

{{< /chapter/section >}}

{{< chapter/section title="Vervolg" level="3">}}

Openstaande activiteiten die in 2026 voortgezet zouden moeten worden zijn:

- Het vaststellingstraject voor AuthZEN NL Gov en Authorisation Decision Log bij de GDI en Forum Standaardisatie

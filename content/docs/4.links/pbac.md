...
- Bestaande trust frameworks
  ...
  - [International Data Spaces Assocation](https://internationaldataspaces.org/) - Zie ook [IDS](../5.architecture/inventarisation/ids)
...
- Zie ook [PBAC](../5.architecture/inventarisation/pbac)
...
- [lock-unlock](https://digilab.overheid.nl/projecten/lock-unlock/) - Zie ook [lock_unlock](../5.architecture/inventarisation/lock_unlock)
...
- [DCAT](http://www.w3.org/TR/vocab-dcat/) - [zie ook DCAT](../5.architecture/inventarisation/dcat)
